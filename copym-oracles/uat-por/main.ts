...
const encodeReceivedBundledReports = (reports: ReceivedBundledReport[]): Hex => {
...
const updateReserves = (
    ...
    runtime.log(`Updating reserves totalReserveScaled ${totalReserveScaled.toString()}`)
...
const doPOR = (runtime: Runtime<Config>): string => {
    ...
    const totalReserveScaled = BigInt(Math.floor(reserveInfo.totalReserve * 1e18))
